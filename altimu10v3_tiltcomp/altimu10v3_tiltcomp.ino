...
//
// To collect data for magneto, use the companion program altimu10v3_cal
//
//
#include <Wire.h>
#include <LSM303.h>
...
// altimu10v3_cal and Magneto. The compass output will not be useful if these constants are not correct
